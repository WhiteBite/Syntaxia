...
export const UI = {
    ...
    COUNT_BOUNCE_DURATION_MS: 300,
    EXPAND_ANIMATION_MS: 300,
    TOOLTIP_DELAY_MS: 150,
    POPOVER_CLOSE_DELAY_MS: 100,
    // Auto-save delays
    AUTO_SAVE_DELAY_MS: 100,
    SAVE_FEEDBACK_DURATION_MS: 2000,
    // Memory cleanup
    GC_DELAY_SHORT_MS: 100,
    GC_DELAY_MEDIUM_MS: 300,
    GC_DELAY_LONG_MS: 500,
    MEMORY_CLEANUP_INTERVAL_MS: 10 * 60 * 1000, // 10 minutes
    // Progress indicators
    PROGRESS_COMPLETE_DELAY_MS: 200,
    COPY_SUCCESS_DURATION_MS: 1500,
    STATUS_MESSAGE_DURATION_MS: 3000,
    STATS_UPDATE_DELAY_MS: 1000,
} as const
