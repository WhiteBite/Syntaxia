...
export function ApplySandboxChanges():Promise<void>;
...
export function CollectSmartContext(arg1:string):Promise<string>;
...
export function DiscardSandboxChanges():Promise<void>;

export function DiscardSandboxFile(arg1:string):Promise<void>;
...
export function GetRecentContexts(arg1:string,arg2:number):Promise<Array<main.ContextMemoryEntry>>;
...
export function GetSandboxAllDiffs():Promise<string>;

export function GetSandboxChangeCount():Promise<number>;

export function GetSandboxChanges():Promise<string>;

export function GetSandboxDiff(arg1:string):Promise<string>;

export function GetSettings():Promise<domain.SettingsDTO>;

export function GetShellIntegrationStatus():Promise<main.ShellIntegrationStatus>;

export function GetSmartSuggestions(arg1:string,arg2:Array<string>,arg3:string):Promise<main.SmartSuggestionsResult>;
...
export function LoadWindowState():Promise<void>;
...
export function RegisterShellIntegration():Promise<void>;
...
export function RequestsyntaxiaContextGeneration(arg1:string,arg2:Array<string>):Promise<void>;
...
export function SaveContextMemory(arg1:string,arg2:string,arg3:string,arg4:Array<string>):Promise<void>;
...
export function TestIgnoreRulesDetailed(arg1:string,arg2:string):Promise<main.IgnorePreviewResult>;
