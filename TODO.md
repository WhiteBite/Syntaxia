...
17. ✅ Size Guard - предупреждения о тяжелых файлах
18. ✅ Context Presets - сохранение/загрузка выборов

### 🟡 ЧАСТИЧНО: 0 задач

### 🔴 НЕ НАЧАТО: 2 задачи (низкий приоритет)

**Задача 24**: Dependency Visualizer - интерактивный граф зависимостей  
